...
- [Example of a dashboard for a research consortium](https://extras.cut.ac.cy/ero/eut-dashboards/){target="_blank"}: A comprehensive dashboard showcasing data visualization and integration techniques used in collaborative research projects.

## Leveraging the Google Ecosystem: Surveys and Dashboards
...
- [Google Forms Overview - YouTube](https://www.youtube.com/watch?v=ylS5jIPea5g): A video tutorial covering the basics of creating surveys using Google Forms.
- [Getting Started with Google Data Studio](https://support.google.com/datastudio/answer/6283323): A comprehensive guide by Google on using Data Studio for data visualization.
...
- [iFrame example of a Shiny questionnaire hosted on demotec](https://digipols-admin.github.io/teaching_template/surveys-tab/tvhours_shiny.html): A demonstration of hosting a Shiny survey. N.B This link may not be working as we are still waiting for https certification!
- [Direct link to Shiny questionnaire hosted on demotec](http://demotec.cut.ac.cy/fernando/tvhours/){target="_blank"}: Access the Shiny questionnaire directly.
...
- [Example of an interactive Quarto report](https://digipols-admin.github.io/teaching_template/surveys-tab/tvhours_static_report.html). N.B. Not availabe yet, pending upload

**Additional Resources:**

- [Hadley Wickham's 2nd Edition R for Data Science - Chapter on Quarto](https://r4ds.had.co.nz/): A comprehensive guide on Quarto and its integration with R.
- [Quarto Documentation: Static Reports](https://quarto.org/docs/authoring/): Official documentation for creating static reports.
- [Quarto Documentation: Interactive Reports with JS Observable](https://quarto.org/docs/interactive/): Learn to integrate JavaScript Observable with Quarto for interactive visualizations.
